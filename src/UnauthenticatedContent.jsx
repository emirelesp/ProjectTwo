...
import DictamenPagina from "./components/validador/DictamenPagina";
  ...
  return (
    <div style={{ width: "100%", height: "100%" }}>
      ...
      >
        ...
        >
          <div className="col-12 text-center">
            <div style={{ height: "250px" }}>
              <div className="p-4 titularesCremita">
                <span>BIENVENIDO</span>
              </div>
              <div className="titularesLineaBlanca">
                <span>
                  Al registrarte en el Sistema tienes acceso al servicio para la
                  gestión de tu
                  <br />
              ...
              <div className="titularesLineaBlanca p-1">
                ¿Ya estás registrado?
              </div>
        ...
        <div className="row titulares text-center p-2">
          {" "}
          <span>{titulo}</span>
        </div>
        <div className="row tema text-center p-2">
          {" "}
          <span>
            Salvo indicación contraria, todos los campos son obligatorios
          </span>
        </div>
        <div className="p-2"></div>
        {children}
...
const Plantilla2 = ({ titulo, children }) => {
  const navigate = useNavigate();
  ...
  return (
    <Routes>
        ...
        element={
          ...
          >
            <div className="container">
              ...
              <div
                className="row text-center titularesLinea"
                style={{ color: "white" }}
              >
              ...
              <div
                className="row text-center p-2 subtitularesLinea"
                style={{ color: "white" }}
              >
                <span>
                  ¿Usuario nuevo?{" "}
              ...
              <div
                className="row text-center p-1 tema"
                style={{ color: "white" }}
              >
                <span>BIENVENIDO</span>
      ...
      <Route
        path="/validador"
        element={
          <Plantilla2 titulo="VALIDADOR">
            <div className="col-xxl-6 col-xl-6 col-lg-8 col-md-8 col-sm-8 col-10 mx-auto p-2">
              <DictamenPagina />
            </div>
          </Plantilla2>
        }
