                ...
                <>
                 <div></div>
                  <button
                   ...
                   >
                    {valor==-1?
                       <span><b>Estatus:</b> en espera fecha de aplicación del examen</span> 
                     :(
                      <>
                       <span>Iniciar {valor==1?(<>primera</>):(<>segunda</>)} parte, haz clic para comenzar. </span>
          ...
          groupCellRender={(cellData) => {
              ...
              return (  
               ...
               { data==1?(
                    ...
                    <span style={{Color:"rgb(30, 91, 79) !important"}}  >Oportunidad 1 - Evaluación Global (EVAL286-EG) </span>
                  ):<></>
                }{
                 data==2?( 
                  (<span>Oportunidad 2 - Evaluación de Recuperación (EVAL286-ER)</span>)
                   ):<></>
                  ...
                  {
                 data==3?( 
                  (<span>Oportunidad 3 - Evaluación de Recuperación (EVAL286-ER)</span>)
                   ):<></>
